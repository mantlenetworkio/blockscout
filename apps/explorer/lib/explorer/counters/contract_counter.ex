defmodule Explorer.Counters.ContractCounter do
  @moduledoc """
  Caches the number of all contract addresses.
  ...
  @table :contract_counter

  @cache_key "contract_addresses"
  ...
  # the test env.
  config = Application.get_env(:explorer, Explorer.Counters.ContractCounter)
  @enable_consolidation Keyword.get(config, :enable_consolidation)

  @update_interval_in_seconds Keyword.get(config, :update_interval_in_seconds)

  @doc """
  Starts a process to periodically update the counter of the number of smart contracts.
  """
  ...
  `config :explorer, Explorer.Counters.ContractCounter, enable_consolidation: true`

  to:

  `config :explorer, Explorer.Counters.ContractCounter, enable_consolidation: false`
  """
