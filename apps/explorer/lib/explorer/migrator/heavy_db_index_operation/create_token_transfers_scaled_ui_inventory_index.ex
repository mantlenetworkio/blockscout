defmodule Explorer.Migrator.HeavyDbIndexOperation.CreateTokenTransfersScaledUiInventoryIndex do
  @moduledoc "Creates the partial index used by ERC-8056 anomaly inventory metrics."
  ...
  ON #{@table_name}(ui_amount_status)
  ...
  @impl HeavyDbIndexOperation
  def update_cache do
    BackgroundMigrations.set_heavy_indexes_create_token_transfers_scaled_ui_inventory_index_finished(true)
  end
end
