defmodule BlockScoutWeb.API.V2.MainPageController do
  ...
  alias BlockScoutWeb.API.V2.{BlockView, OptimismView, TransactionView, MantleView}
  ...
  def mantle_deposits(conn,_params) do
    recent_deposits =
    ...
    |> put_status(200)
    |> put_view(MantleView)
    |> render(:mantle_deposits, %{deposits: recent_deposits})
  end
